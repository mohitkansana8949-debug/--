...
export default function CertificatePage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
            <div className="w-full max-w-4xl bg-background text-foreground rounded-lg shadow-2xl border-4 border-primary p-8 relative overflow-hidden">
                {/* Decorative elements */}
                <div className="absolute top-0 left-0 w-32 h-32 border-t-8 border-l-8 border-amber-400 rounded-tl-lg opacity-50"></div>
                <div className="absolute bottom-0 right-0 w-32 h-32 border-b-8 border-r-8 border-amber-400 rounded-br-lg opacity-50"></div>

                <div className="text-center space-y-6 relative z-10">
                    <Award className="mx-auto h-24 w-24 text-amber-500" />

                    <h1 className="text-5xl font-bold text-primary tracking-wider font-display">
                    ...
                    <h2 className="text-4xl font-semibold font-serif text-amber-600 dark:text-amber-400">
                 ...
                 <div className="mt-12 text-center relative z-10">
                    <p className="text-lg font-bold">Quickly Study</p>
